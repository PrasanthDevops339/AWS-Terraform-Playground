...
variable "workloadsLEGACY" {
  description = "ID of legacy workloads OU"
  type        = string
}

variable "workloadsLEGACY_dev" {
  description = "ID of legacy workloads dev OU"
  type        = string
}

variable "workloadsLEGACY_tst" {
  description = "ID of legacy workloads tst OU"
  type        = string
}

variable "workloadsLEGACY_prd" {
  description = "ID of legacy workloads prd OU"
  type        = string
}

variable "audit" {
  description = "ID of audit account"
  type        = string
}

variable "acme_aftwld_dev" {
